(function () {
  ...
  var questions = [
    ...
    {prompt:"You want a portable vegetarian breakfast with more published protein and fiber. Which snapshot fits better?",answers:["Starbucks Eggs & Cheddar Protein Box","Dunkin’ Egg & Cheese Wake-Up Wrap","McDonald’s Apple Slices"],correct:0,explanation:"The Starbucks box lists 22 g protein and 5 g fiber. The Dunkin’ wrap lists 7 g protein and 0 g fiber; apple slices are a side."},
    ...
    {prompt:"You want a substantial plant-based meal with published protein and fiber. Which choice is the strongest starting point?",answers:["Chipotle Sofritas Bowl","Panda Express Super Greens by itself","McDonald’s Apple Slices by itself"],correct:0,explanation:"The Sofritas Bowl lists 620 calories, 23 g protein and 15 g fiber. Super Greens and apple slices can be useful sides, but they are not comparable full meals."},
