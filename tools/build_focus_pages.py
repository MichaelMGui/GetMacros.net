...
def build_about(meals: list[dict]) -> None:
    ...
    chain_count=len({m['chain'] for m in meals})
    body=f'''{head("about.html",title,meta,schema=schema)}<body class="site-v3 recovery-page about-page">{nav("about")}<main id="main-content">
{breadcrumbs([("Home","index.html"),("About",None)])}<section class="focus-page-hero about-hero"><div class="container about-hero-grid"><div><p class="eyebrow">About GetMacros</p><h1>Food decisions, backed by numbers you can check</h1><p>GetMacros helps you set a starting macro target, compare complete restaurant orders and understand the trade-offs behind the numbers.</p><div class="about-hero-actions"><a class="btn btn-primary" href="restaurant-meal-finder.html">Find a restaurant meal</a><a class="about-text-link" href="sources.html">See every source <span aria-hidden="true">&rarr;</span></a></div></div><aside class="about-proof" aria-label="Current GetMacros coverage"><p>Current site coverage</p><div><span><strong>{len(meals)}</strong><small>tracked menu options</small></span><span><strong>{chain_count}</strong><small>restaurant chains</small></span><span><strong>9</strong><small>free nutrition tools</small></span></div><p class="about-proof-note">No account required. No restaurant sponsors these rankings.</p></aside></div></section>

<section class="about-purpose" id="what-getmacros-does"><div class="container"><header class="about-section-head"><p class="eyebrow">What the site is for</p><h2>Start with the decision in front of you</h2><p>You do not need to read the whole site. Choose the job you need done.</p></header><div class="about-purpose-grid">
<a class="about-purpose-card" href="restaurant-meal-finder.html"><span class="about-icon"><svg aria-hidden="true"><use href="icon-sprite.svg#icon-target"></use></svg></span><span class="about-card-num">01</span><h3>Choose a restaurant meal</h3><p>Answer five useful questions and get complete orders ranked for your goal.</p><b>Use Healthy Order Match <span aria-hidden="true">&rarr;</span></b></a>
<a class="about-purpose-card" href="calculators.html"><span class="about-icon"><svg aria-hidden="true"><use href="icon-sprite.svg#icon-calculator"></use></svg></span><span class="about-card-num">02</span><h3>Estimate calories and macros</h3><p>See the equation, assumptions and daily protein, carb and fat estimate.</p><b>Open the calculators <span aria-hidden="true">&rarr;</span></b></a>
<a class="about-purpose-card" href="articles.html"><span class="about-icon"><svg aria-hidden="true"><use href="icon-sprite.svg#icon-book"></use></svg></span><span class="about-card-num">03</span><h3>Understand what a number means</h3><p>Read practical guides about protein, portions, labels and eating out.</p><b>Browse nutrition guides <span aria-hidden="true">&rarr;</span></b></a>
</div></div></section>

<section class="data-section about-method"><div class="container"><header class="about-section-head"><p class="eyebrow">How it works</p><h2>From a published menu to a useful comparison</h2><p>The method is deliberately simple enough to inspect.</p></header><div class="about-method-grid">
<article><span class="about-step-icon"><svg aria-hidden="true"><use href="icon-sprite.svg#icon-document"></use></svg></span><b>01</b><h3>Start with the official source</h3><p>Restaurant figures come from each chain&rsquo;s published nutrition information. Every guide links back to it and shows when it was checked.</p></article>
<article><span class="about-step-icon"><svg aria-hidden="true"><use href="icon-sprite.svg#icon-rice-bowl"></use></svg></span><b>02</b><h3>Keep the whole order visible</h3><p>Combined meals name every included item. Missing sodium, fiber or another value stays missing&mdash;it never becomes zero.</p></article>
<article><span class="about-step-icon"><svg aria-hidden="true"><use href="icon-sprite.svg#icon-target"></use></svg></span><b>03</b><h3>Rank for the user&rsquo;s goal</h3><p>Cutting, bulking and high-protein preferences change the order. Calories, protein, fiber and sodium remain visible together.</p></article>
</div><p class="about-method-link"><a href="sources.html">Read the complete data and calculator method <span aria-hidden="true">&rarr;</span></a></p></div></section>

<section class="about-standards"><div class="container about-standards-grid"><article><p class="eyebrow">The standard</p><h2>Useful without pretending to be perfect</h2><ul class="about-check-list"><li><svg aria-hidden="true"><use href="icon-sprite.svg#icon-check"></use></svg><span><strong>Estimates are labelled as estimates.</strong> Calculator outputs are starting points, not prescriptions.</span></li><li><svg aria-hidden="true"><use href="icon-sprite.svg#icon-check"></use></svg><span><strong>Trade-offs stay visible.</strong> High protein does not erase calories or sodium.</span></li><li><svg aria-hidden="true"><use href="icon-sprite.svg#icon-check"></use></svg><span><strong>Bylines stay honest.</strong> GetMacros does not invent doctors, dietitians or fake expert reviewers.</span></li><li><svg aria-hidden="true"><use href="icon-sprite.svg#icon-check"></use></svg><span><strong>Corrections have a route.</strong> A specific error can be reported and logged.</span></li></ul></article><aside class="about-boundary"><span class="about-icon"><svg aria-hidden="true"><use href="icon-sprite.svg#icon-shield"></use></svg></span><p class="eyebrow">Important boundary</p><h2>Education, not personal medical care</h2><p>GetMacros is built for generally healthy adults making everyday food decisions. It does not diagnose conditions or replace a clinician.</p><p>General calculators may be the wrong tool during pregnancy, growth, eating-disorder recovery or when a health condition changes nutrition needs.</p></aside></div></section>

<section class="data-section about-accountability"><div class="container"><header class="about-section-head"><p class="eyebrow">Check the work</p><h2>Sources, standards and corrections are part of the product</h2><p>Trust pages should be easy to find before something goes wrong.</p></header><div class="about-accountability-grid"><a href="sources.html"><span class="about-icon"><svg aria-hidden="true"><use href="icon-sprite.svg#icon-document"></use></svg></span><h3>Sources and methods</h3><p>See restaurant sources, calculator equations and the thresholds used in rankings.</p><b>Review sources <span aria-hidden="true">&rarr;</span></b></a><a href="editorial-policy.html"><span class="about-icon"><svg aria-hidden="true"><use href="icon-sprite.svg#icon-book"></use></svg></span><h3>Editorial policy</h3><p>Read how pages are scoped, written, checked and updated.</p><b>Read the policy <span aria-hidden="true">&rarr;</span></b></a><a href="corrections.html"><span class="about-icon"><svg aria-hidden="true"><use href="icon-sprite.svg#icon-mail"></use></svg></span><h3>Report a problem</h3><p>Send the page, the value in question and the official source when possible.</p><b>Open corrections <span aria-hidden="true">&rarr;</span></b></a></div><p class="about-independent">GetMacros is independent. Restaurant names and menu information belong to their respective owners; no listed chain sponsors or endorses this site.</p></div></section>
<div class="ad-auto-anchor" aria-hidden="true"></div></main>{footer()}</body></html>'''
