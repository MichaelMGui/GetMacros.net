...
<article class="tool-group" id="goal-tools"><div class="tool-group-head"><span class="tool-group-icon" aria-hidden="true">02</span><div><h3>Goals, training and eating out</h3><p>Estimate a timeline, measure observed sweat loss or compare restaurant meals.</p></div></div><div class="tool-links"><a href="weight-goal-timeline-calculator.html">Weight Goal Timeline Calculator <span>→</span></a><a href="sweat-rate-calculator.html">Sweat Rate Calculator <span>→</span></a><a href="restaurant-meal-finder.html">Healthy Fast-Food Meal Finder <span>→</span></a></div></article>
